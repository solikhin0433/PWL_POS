...
label="Close"><span aria-hidden="true">&times;</span></button> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    ...
                    <a href="{{ asset('template_supplier.xlsx') }}" class="btn btn-info btn
sm" download><i class="fa fa-file-excel"></i> Download</a> 
                    <small id="error-supplier_kode" class="error-text form-text text
danger"></small> 
                </div> 
                <div class="form-group"> 
                    <label>Pilih File</label> 
                    <input type="file" name="file_supplier" id="file_supplier" class="form
control" required> 
                    <small id="error-file_supplier" class="error-text form-text text
danger"></small> 
                </div> 
            </div> 
