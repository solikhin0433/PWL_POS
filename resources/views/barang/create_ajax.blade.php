<form action="{{ url('/barang/ajax') }}" method="POST" id="form-tambah-barang" enctype="multipart/form-data">
    @csrf
    ...
    $(document).ready(function() {
        $("#form-tambah-barang").validate({
            rules: {
                ...
                avatar: { extension: "jpg,jpeg,png" } // Optional: validate file type
            },
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.status){
                            ...
                            dataBarang.ajax.reload(); // Reload the DataTable
                        } else {
                            $('.error-text').text('');
