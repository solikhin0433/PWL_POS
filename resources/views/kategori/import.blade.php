...
label="Close"><span aria-hidden="true">&times;</span></button> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    ...
                    <a href="{{ asset('template_kategori.xlsx') }}" class="btn btn-info btn
...
danger"></small> 
                ...
                <div class="form-group"> 
                    ...
                    <input type="file" name="file_kategori" id="file_kategori" class="form
control" required> 
                    <small id="error-file_kategori" class="error-text form-text text
danger"></small> 
                </div> 
            </div> 
